    ...
    <main className="overflow-x-hidden">
      ...
      <section className="bg-[var(--color-surface)] relative overflow-hidden">
        ...
        <div aria-hidden className="pointer-events-none absolute inset-0 z-0 opacity-40">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[var(--color-surface)]/35" />
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-5 py-14 sm:px-6 md:py-20">
          ...
          >
            <motion.p
              variants={fadeUp}
              className="text-xs font-semibold tracking-widest text-[var(--color-text-secondary)]"
            >
            ...
            <motion.p variants={fadeUp} className="mt-5 text-base text-[var(--color-text-secondary)] md:text-lg">
            ...
            <motion.div variants={fadeUp} className="mt-8 flex flex-wrap gap-3">
              ...
              <Link
                href="/work"
                className="inline-flex items-center justify-center rounded-full border border-[var(--color-border)] px-6 py-3 text-sm font-semibold text-[var(--color-text-primary)] transition hover:bg-[var(--color-surface)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] focus-visible:ring-offset-2"
              >
                See Our Work
              </Link>
            </motion.div>
            ...
            <motion.div
              variants={fadeUp}
              className="mt-8 grid gap-3 text-sm text-[var(--color-text-secondary)] sm:grid-cols-3"
            >
              <div className="rounded-2xl border border-[var(--color-border)] bg-white p-4 shadow-sm">
                <div className="text-xs">Focus</div>
                <div className="mt-1 font-semibold text-[var(--color-text-primary)]">Decision-grade BI</div>
              </div>
              <div className="rounded-2xl border border-[var(--color-border)] bg-white p-4 shadow-sm">
                <div className="text-xs">Build</div>
                <div className="mt-1 font-semibold text-[var(--color-text-primary)]">AI integrated systems</div>
              </div>
              <div className="rounded-2xl border border-[var(--color-border)] bg-white p-4 shadow-sm">
                <div className="text-xs">Ship</div>
                <div className="mt-1 font-semibold text-[var(--color-text-primary)]">Fast web platforms</div>
              </div>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-5 py-14 sm:px-6">
        <div className="grid gap-6 md:grid-cols-2">
          <motion.div
            ...
            variants={stagger}
            className="rounded-2xl border border-[var(--color-border)] bg-white p-7 shadow-sm"
          >
            <motion.h2 variants={fadeUp} className="text-2xl font-semibold md:text-3xl">
              Our mission
            </motion.h2>
            <motion.p variants={fadeUp} className="mt-3 text-[var(--color-text-secondary)]">
            ...
            <motion.div variants={fadeUp} className="mt-6 grid gap-3 text-sm">
              <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4">
                ...
                <div className="mt-1 text-[var(--color-text-secondary)]">BI dashboards designed for executive decisions.</div>
              </div>
              <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4">
                <div className="font-semibold">Leverage</div>
                <div className="mt-1 text-[var(--color-text-secondary)]">AI copilots that compress analysis time.</div>
              </div>
              <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4">
                <div className="font-semibold">Speed</div>
                <div className="mt-1 text-[var(--color-text-secondary)]">Web platforms engineered to perform and scale.</div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <motion.ol variants={fadeUp} className="mt-6 grid gap-3 text-sm">
              <li className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4">
                ...
                <div className="mt-1 text-[var(--color-text-secondary)]">KPIs, stakeholders, data sources, constraints.</div>
              </li>
              <li className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4">
                <div className="font-semibold">2) Design</div>
                <div className="mt-1 text-[var(--color-text-secondary)]">Information architecture, dashboard flows, UI system.</div>
              </li>
              <li className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4">
                <div className="font-semibold">3) Build</div>
                <div className="mt-1 text-[var(--color-text-secondary)]">Pipelines, models, dashboards, AI modules, web apps.</div>
              </li>
              <li className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4">
                <div className="font-semibold">4) Ship & iterate</div>
                <div className="mt-1 text-[var(--color-text-secondary)]">Performance, QA, enablement, continuous improvement.</div>
              </li>
            </motion.ol>
          </motion.div>
        </div>
